...
export default function Catalog({ products, category, onAddToCart }: CatalogProps) {
  ...
  const filteredProducts = products.filter(product => {
    ...
    if (filters.frameShape && product.frameShape !== filters.frameShape) return false;
  ...
  const activeFiltersCount = Object.values(filters).filter(v => v && v !== category).length;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-black mb-2">
            {category ? (category === 'sunglasses' ? 'Sunglasses' : 'Eyeglasses') : 'All Products'}
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className={`${showFilters ? 'block' : 'hidden'} lg:block w-full lg:w-64 flex-shrink-0`}>
            <div className="bg-white p-6 rounded-lg shadow-sm sticky top-24">
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center">
                      <input
                        type="radio"
                        name="category"
                        checked={filters.category === 'sunglasses'}
                        onChange={() => setFilters({ ...filters, category: 'sunglasses' })}
                        className="mr-2 accent-emerald-500"
                      />
                    ...
                    <label className="flex items-center">
                      <input
                        type="radio"
                        name="category"
                        checked={filters.category === 'eyeglasses'}
                        onChange={() => setFilters({ ...filters, category: 'eyeglasses' })}
                        className="mr-2 accent-emerald-500"
                      />
                      <span className="text-gray-700">Eyeglasses</span>
                    </label>
                  </div>
                </div>
              )}
              ...
              <div className="mb-6">
                <h3 className="font-semibold mb-3 text-gray-900">Frame Shape</h3>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      onChange={() => setFilters({ ...filters, frameShape: '' })}
                      className="mr-2 accent-emerald-500"
                    />
                    <span className="text-gray-700">All</span>
                  </label>
                  {frameShapes.map(shape => (
                    <label key={shape} className="flex items-center">
                      <input
                        ...
                        onChange={() => setFilters({ ...filters, frameShape: shape })}
                        className="mr-2 accent-emerald-500"
                      />
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={() => setFilters({ ...filters, priceRange: '0-100' })}
                      className="mr-2 accent-emerald-500"
                    />
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={() => setFilters({ ...filters, priceRange: '100-150' })}
                      className="mr-2 accent-emerald-500"
                    />
                    <span className="text-gray-700">$100 - $150</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      onChange={() => setFilters({ ...filters, priceRange: '150' })}
                      className="mr-2 accent-emerald-500"
                    />
              ...
              <div className="mb-6">
                <h3 className="font-semibold mb-3 text-gray-900">Gender</h3>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input
                      type="radio"
