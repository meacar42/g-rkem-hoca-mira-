...
import { ShoppingCart, Truck, RotateCcw, Shield, Star, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to={`/${product.category}`} className="inline-flex items-center text-emerald-500 hover:text-emerald-600 mb-8">
