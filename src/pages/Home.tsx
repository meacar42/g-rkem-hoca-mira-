...
export default function Home({ products, onAddToCart }: HomeProps) {
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-gray-50">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 leading-tight">
            See the World <span className="text-emerald-500">Clearly</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Premium eyewear designed for style, comfort, and crystal-clear vision
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/eyeglasses">
              <Button variant="outline" size="lg">Shop Eyeglasses</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link to="/sunglasses" className="group">
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                  <div className="p-8 w-full">
                    <h2 className="text-4xl font-bold text-white mb-2">Sunglasses</h2>
                    <p className="text-gray-200 mb-4">Protect your eyes in style</p>
            ...
            <Link to="/eyeglasses" className="group">
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-lg">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                  <div className="p-8 w-full">
                    <h2 className="text-4xl font-bold text-white mb-2">Eyeglasses</h2>
                    <p className="text-gray-200 mb-4">Vision meets fashion</p>
                    <Button>Shop Now</Button>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Handpicked styles for every personality</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">Personalized assistance</p>
            </div>
          </div>
        </div>
      </section>
