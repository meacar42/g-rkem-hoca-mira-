        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><Link to="/sunglasses" className="hover:text-emerald-500 transition-colors">Shop Sunglasses</Link></li>
              <li><Link to="/eyeglasses" className="hover:text-emerald-500 transition-colors">Shop Eyeglasses</Link></li>
